...
import com.github.tyang513.batch.probe.util.StringUtils;
...
public class Map<K, V> extends HashMap<K, V> {
    ...
    public boolean getBoolValue(String key, boolean defaultValue) {
        return StringUtils.stringToBool(getStringValue(key), defaultValue);
    }
    ...
    public int getIntValue(String key, int defaultValue) {
        return StringUtils.stringToInt(getStringValue(key), defaultValue);
    }
    ...
    public long getLongValue(String key, long defaultValue) {
        return StringUtils.stringToLong(getStringValue(key), defaultValue);
    }
    ...
    public double getDoubleValue(String key, double defaultValue) {
        return StringUtils.stringDouble(getStringValue(key), defaultValue);
    }
